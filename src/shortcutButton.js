...
export class OnDemandShortcutButton extends Gtk.Stack {
    static {
        GObject.registerClass({
            GTypeName: 'OnDemandShortcutButton',
            Properties: {
    ...
    constructor(settings, params) {
        ...
        this.keybinding = this.settings.get_strv("gravatar-ondemand-keybinding")[0];
